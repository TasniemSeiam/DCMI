...
const CompanyOverViewCard = ({ iconImage, title, description }) => {
  return (
    <div
      className={`${style.card} h-100  px-5 py-5 text-md-start text-center card  mb-3 aos-init `} data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1000" data-aos-delay="500"
    >
